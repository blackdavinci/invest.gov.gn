...
@section('content-title','Nouveau secteur')

@section('small-content-title','Création d\'un nouveau secteur')
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">Nouveau secteur</h3>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    <div class="col-md-12">
      <!-- form start -->
      {!! Form::open(['method' =>'POST','route' =>['secteurs.store'],'files' => true,'class'=>'form-horizontal']) !!}
        <div class="box-body">
          <div class="form-group{{ $errors->has('secteur_nom') ? ' has-error' : '' }}">
            <label for="nom" class="col-sm-2 control-label">Nom</label>

            <div class="col-sm-10">
              <input type="text" class="form-control" id="nom" placeholder="Nom du secteur (Agriculture, Mines, etc)" name="secteur_nom" value="{{ old('secteur_nom') }}" required>
          ...
          <div class="form-group {{ $errors->has('secteur_presentation') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-10">
             <textarea class="form-control summernote" rows="3" placeholder="Description du secteur ..." name="secteur_presentation">{{ old('secteur_presentation')}}</textarea>
          ...
          <div class="form-group{{ $errors->has('secteur_resume') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
             <textarea class="form-control summernote" rows="3" placeholder="Résumé sur le secteur ..." name="secteur_resume">{{ old('secteur_resume') }}</textarea>
